...
<body>
	...
	<div id="header">
		<div>
			...
			<ul id="navigation">
				...
				<li >
					<?php echo "<a href='ponits.php?ip_mh=$_GET[ip_mh]'>Quản lý điểm</a>";?>
				</li>
				<li>
	...
	<div id="contents">
		<div id="about">
			<h1> ĐIỂM DANH TRONG GIỜ HỌC </h1>
			<h2> tích vào những sinh viên vắng mặt </h2>
			<form method="post" <?php echo "action='random_dd0.php?ip_mh=$_GET[ip_mh]'";?> id="random_dd"> 
				<table>
